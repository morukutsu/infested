...
*/
    ...
    let pixel = { scale: 2, canvas: null, context: null, width: 0, height: 0 };
    ...
    //console.log(Phaser);
    let game = new Phaser.Game(pixel.width / pixel.scale, pixel.height / pixel.scale, Phaser.CANVAS, '', worldState);
